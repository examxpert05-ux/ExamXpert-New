        ...
        <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50 dark:from-slate-900 dark:via-slate-800 dark:to-slate-900 flex items-center justify-center p-4">
            ...
            >
                ...
                <motion.div variants={fadeInUp} className="text-center mb-8">
                    ...
                    <h1 className="text-3xl font-bold text-slate-900 dark:text-white mb-2">Join ExamXpert</h1>
                    <p className="text-slate-600 dark:text-slate-300">Create your account and start your learning journey</p>
                </motion.div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <div>
                            ...
                            <div className="relative">
                                <select
                                    ...
                                    onChange={handleInputChange}
                                    required
                                    className="w-full pl-4 pr-10 py-3 border border-slate-300 dark:border-slate-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-white dark:bg-slate-700 text-slate-900 dark:text-white appearance-none"
                                >
                                    <option value="">Choose your test</option>
                                    {Object.entries(testConfigs).map(([code, config]) => (
                        ...
                        <div className="flex items-start">
                            <input
                                ...
                                className="w-4 h-4 text-blue-600 bg-slate-100 border-slate-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-slate-800 focus:ring-2 dark:bg-slate-700 dark:border-slate-600 mt-0.5"
                            />
